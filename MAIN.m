...
% Directory pointers
% ------------------
  DIRECTORY_data = 'BDM_DATA';
  addpath( DIRECTORY_data )
  DIRECTORY_setup = 'TEST_BDM'; 
...
% Beardmore data
% ================
load beardmore_accum_width_velocity.mat
load beardmore_tributaries.mat
...
hold on
plot(measures_centerline_distance/1000, measures_flowspeed,'m', 'linewidth', 1)
