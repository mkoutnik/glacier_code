 function [ S_0, h_0, ...
            dS_dx_P, ...
            dS_dx_edges ] = calc_h_0_flux_add( x_P, x_w, x_e, dx_P, ...
                                      B_P, B_w, B_e, W_P, W_w, W_e, ...
                                      b_dot_edges, slip_w, slip_e, ...
...
%  use known thickness at x_w(1) to find slope at x_w(1)
      slope_w(1) =  dSurf_0_dx_flux_add( x_w(1), x_P, x_w, x_e, dx_P, ...
                               S_w(1), B_w, B_e, W_w, W_e, ...
                               slip_w, slip_e, b_dot_w, b_dot_e, ...
                               Q_0_in, A_T_w, A_T_e, flux_add_w(1) );                        
%
...
%   -----------------------------------------------------------------
  ...
  for i = 1:N_x
    ...
    %  (a) get slope
        slope_i = dSurf_0_dx_flux_add( x_P(i), x_P, x_w, x_e, dx_P, ...
                               S_0(i), B_w, B_e, W_w, W_e, ...
                               slip_w, slip_e, b_dot_w, b_dot_e, ...
                               Q_0_in, A_T_e, A_T_w, flux_add_P(i) );                        
  ...
  %  loop to find corrections to S_e(i)
     ...
     %  find trial slope at x_e(i)
          slope_e_a =  dSurf_0_dx_flux_add( x_e(i), x_P, x_w, x_e, dx_P, ...
                                   S_e_trial, B_w, B_e, W_w, W_e, ...
                                   slip_w, slip_e, b_dot_w, b_dot_e, ...
                                   Q_0_in, A_T_e, A_T_w, flux_add_e(i) );                        
     ...
     %  find trial slope at x_e(i) with perturbed thickness
          slope_e_b =  dSurf_0_dx_flux_add( x_e(i), x_P, x_w, x_e, dx_P, ...
