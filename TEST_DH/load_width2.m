...
%W_P = interp1(Hat_width_centerline_distance, Hat_width./Hat_width(1), x_P, 'linear', 'extrap');
%W_P = interp1(Hat_width_centerline_distance, Hat_width, x_P, 'linear', 'extrap');
W_P = interp1(Hat_width_x, Hat_width_values, x_P, 'linear', 'extrap');
